...
```mermaid
graph TD
    A[Nefs-i Emmare / Bencillik] -->|Dünyevi Arzulardan Vazgeçiş| B(Kurban / Fedakarlık)
    B --> C{Kalbin Arınması}
    C -->|Takva| D[Allah'a Yakınlaşma / Kurbiyet]
    C -->|Egodan Sıyrılma| E[Hiçlik / Fena Fillah]
    D --> F((Mutlak Teslimiyet / Beka Billah))
    E --> F
```
...
### 2. Sünnette Kurban Uygulaması ve Veda Haccı
...
### 3. Fıkhî Açıdan Udhiyye ve Kurbanın Sırları
...
### 1. İmam Gazzali: İhyâ'da Kurbanın Sırları
...
### 2. İbn Arabî ve Vahdet-i Vücud'da "Hiçlik" (Fena Fillah)
...
### 3. Hallac-ı Mansur ve Hak Yolu'nda Canı Feda Etmek
...
*   📖 **`kuran_ve_sunnet/`**: Kur'an ayetleri tefsirleri (Hac ve Saffat sureleri), Hadis-i Şerifler, Veda Haccı uygulamaları ve fıkhî "Udhiyye" kavramları.
...
*   🖋️ **`edebi_yansimalar/`**: Şiirlerde ve mesnevilerde ilahi aşk uğruna canı feda etme temaları. (Mevlana, Fuzuli, Yunus Emre vb.)
